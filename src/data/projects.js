...
export const projectData = [
  {
    id: 1,
    title: "ShopNow — Full-Stack MERN E-Commerce Platform",
    desc: "ShopNow is a full-stack e-commerce web application built with MongoDB, Express.js, React, and Node.js.It includes core e-commerce features such as product listing, filtering, sorting, cart management, wishlist, and user authentication. The application also has an admin panel for managing products, users, and orders.The frontend is built with React and styled using Tailwind CSS, while the backend handles API development, authentication, and database operations using Express and MongoDB.The project is structured in a way that keeps frontend and backend separated and easy to maintain, with a focus on clean code and reusable components.",
    img: ecommerce,
    link: "https://shop-now-client-iota.vercel.app/",
  },
  {
    id: 2,
